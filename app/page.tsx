                    ...
                    <div className=' rounded-md  bg-green-100 flex sm:flex-col flex-row items-center justify-ceter'>
                        <div className='text-center py-2'>
                            ...
                            <div className='flex space-x-2 justify-center item-center mb-2'>
                                <span className=''>
                                    <h1 className="text-slate-950 text-sm">
                                        <span><LocationOn className="text-slate-900 mx-5" /></span>Get out to us, and let know your needs and tell you how we get you covered
                                    </h1>
                                </span>
                            </div>
